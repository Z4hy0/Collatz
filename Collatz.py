# Loop para que um número natural positivo seja inserido
while True:
    c0 = int(input("Digite um número"))
    if c0 > 0: # Sai do loop se o número for positivo
        break
    else:
        print("Erro! Digite um número natural positivo maior que zero")
steps = 0  # Contador de etapas

while c0 != 1:  # Executa o loop até que c0 seja igual a 1
